...
fns = [
    ...
    'PANetDilatedResNet34_768_Fold0/pred_tta.zip',
    'PANetDilatedResNet34_768_Fold1/pred_tta.zip',
    'PANetDilatedResNet34_768_Fold3/pred_tta.zip',
    'PANetDilatedResNet34_768_Fold4/pred_tta.zip',

    'PANetResNet50_768_Fold0/pred_tta.zip',
    'PANetResNet50_768_Fold1/pred_tta.zip',
    'PANetResNet50_768_Fold2/pred_tta.zip',
    'PANetResNet50_768_Fold3/pred_tta.zip',

    'EMANetResNet101_768_Fold7/pred_tta.zip',
    'EMANetResNet101_768_Fold8/pred_tta.zip',
