...
# from .sync_bn.inplace_abn import InPlaceABNSync
...
def Norm2d(feat, num_groups=16, momentum=BN_MOMENTUM):
    return nn.GroupNorm(num_groups, feat)
    ...
    def init_weights(self, pretrained='', ):
        ...
        if os.path.isfile(pretrained):
            ...
            pretrained_dict = {k.lstrip('model.'): v for k, v in pretrained_dict.items()
                               if k.lstrip('model.') in model_dict.keys()}
